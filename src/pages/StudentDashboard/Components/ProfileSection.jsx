  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent1/10 to-accent/20 dark:from-gray-900 dark:to-gray-800 py-8">
      <div className="max-w-6xl mx-auto px-4 space-y-6">
        ...
        {/* Identification */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-xl p-6 space-y-4 border border-gray-200 dark:border-gray-600">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Identification</h2>
        ...
        {/* Guardian */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-xl p-6 space-y-2 border border-gray-200 dark:border-gray-600">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Parent/Guardian</h2>
          <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg border border-gray-200 dark:border-gray-600">
            <div className={labelClass}>Name</div>
