      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-500 px-8 py-8 shadow-lg">
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm mt-1.5">Customize your account preferences</p>
            </div>
          </div>
        </div>
        ...
        <div className="">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <div
              id="appearance"
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-tertiary/10 overflow-hidden"
            >
            ...
            <div
              id="notifications"
              className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-lg border border-gray-100 dark:border-gray-600 p-6"
            >
            ...
            */}
            ...
            >
              ...
              <div className="p-6 space-y-4">
                {passwordError && (
                  <div className="p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-sm text-red-700 dark:text-red-400 rounded-lg">
                    {passwordError}
                  </div>
                )}
                {passwordMessage && (
                  <div className="p-3 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-sm text-green-700 dark:text-green-400 rounded-lg">
                    {passwordMessage}
                  </div>
                )}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full p-3 pr-12 border rounded-lg focus:ring-2 focus:ring-opacity-50 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
