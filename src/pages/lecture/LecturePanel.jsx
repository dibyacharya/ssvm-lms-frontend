...
export default function LecturePanel() {
  ...
  // Only show modules that have lectures with actual recordings (videoUrl or recordingUrl)
  const modulesWithLectures = course.syllabus.modules
    .map((module) => ({
      ...module,
      lectures: (module.lectures || []).filter(
        (l) => l.videoUrl || l.recordingUrl
      ),
    }))
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-rose-100 text-sm mt-1">
                    Watch recorded lectures and review class content
                  </p>
                </div>
              </div>
            </div>
