  ...
  <div className="flex items-center justify-between mb-8">
    {steps.map((step, index) => (
      <div key={step.number} className="flex items-center">
        ...
        >
          <div className={`w-10 h-10 rounded-full flex items-center justify-center text-gray-900 font-semibold transition-all duration-300 ${
            step.number === currentStep ? 'bg-blue-500 ring-4 ring-blue-100 scale-110' :
            step.number < currentStep ? 'bg-blue-500 hover:bg-blue-600 hover:scale-105' : 'bg-gray-300'
          }`}>
