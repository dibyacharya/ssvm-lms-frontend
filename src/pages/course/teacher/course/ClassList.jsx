...
const ClassList = () => {
  ...
  const getDayColor = (day) => {
    const colors = {
      ...
      Tuesday: "bg-blue-50 text-blue-600 border-blue-200",
      ...
      Saturday: "bg-blue-50 text-blue-600 border-blue-200",
      Sunday: "bg-blue-50 text-blue-600 border-blue-200",
    };
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 p-8 shadow-lg">
        ...
        <div className="relative z-10 flex items-center gap-5">
          <div className="w-14 h-14 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-inner">
            <CalendarCheck className="w-7 h-7 text-gray-900" />
          </div>
          <div>
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden h-full hover:shadow-md transition-shadow duration-300">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center p-4 rounded-xl border border-tertiary/10 bg-gray-50 hover:border-indigo-200 hover:bg-blue-50/50 transition-all duration-200 cursor-default">
              ...
              <div className="flex items-center p-4 rounded-xl border border-tertiary/10 bg-gray-50 hover:border-indigo-200 hover:bg-blue-50/50 transition-all duration-200 cursor-default">
                <BookOpen className="w-5 h-5 text-blue-500 mr-4 flex-shrink-0" />
                <div>
      ...
      {/* Info Banner */}
      <div className="relative overflow-hidden rounded-2xl border border-indigo-100 bg-gradient-to-r from-blue-50 to-blue-50 shadow-sm">
        ...
        <div className="flex items-start p-5 pl-6">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm shadow-indigo-200 mr-4 flex-shrink-0">
