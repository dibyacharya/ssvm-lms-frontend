  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-primary">Class Schedule</h1>
              ...
              {dateItems.map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-semibold text-tertiary/70 uppercase tracking-wider">
                      {item.label}
                    </p>
              ...
              <div className="space-y-3">
                {classDaysAndTimes.length > 0 ? (
                  classDaysAndTimes.map((schedule, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between p-4 rounded-xl bg-gray-50 border border-tertiary/10 hover:border-primary/20 hover:shadow-sm transition-all duration-200"
                    >
