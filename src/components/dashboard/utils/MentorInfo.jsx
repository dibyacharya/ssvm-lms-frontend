...
const MentorDetails = ({ teacher }) => {
  ...
  return (
    <div className="bg-white dark:bg-white shadow-md dark:shadow-lg rounded-xl overflow-hidden transition-all border border-gray-100 dark:border-gray-300">
      <button
        className="w-full flex justify-between items-center p-4 bg-gradient-to-r from-white to-gray-200 dark:from-gray-700 dark:to-gray-600 text-black dark:text-gray-900 font-semibold text-lg hover:opacity-90 transition-all"
      >
        <div className="flex items-center space-x-2">
          <GraduationCap className="w-5 h-5 text-red-500 dark:text-red-600" />
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-900">{teacher.name || ""}</h2>
        </div>

        {teacher.profTitle && (
          <div className="flex items-center space-x-3">
            <GraduationCap className="w-6 h-6 text-blue-600 dark:text-blue-400" />
            <p className="text-gray-700 dark:text-gray-600 font-medium">
              {teacher.profTitle}
            </p>
          </div>
        )}
        ...
        {teacher.profDesc && (
          <div className="flex items-center space-x-3">
            ...
            <p className="text-gray-600 dark:text-gray-600">{teacher.profDesc}</p>
          </div>
        )}
