...
const AssignmentsList = ({setSelectedOption}) => {
  ...
  if (isLoading) {
    return (
      <div className="p-4 text-center bg-white dark:bg-white rounded-lg shadow-md dark:shadow-lg">
        <LoadingSpinner />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="p-4 text-red-500 dark:text-red-600 bg-white dark:bg-white rounded-lg shadow-md dark:shadow-lg border border-red-200 dark:border-red-800">
        {error}
      </div>
    );
  }
  ...
  return (
    <div className="bg-white dark:bg-white rounded-lg shadow-md dark:shadow-lg p-6 border border-gray-100 dark:border-gray-300">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-900">Assignments</h2>
        <button
