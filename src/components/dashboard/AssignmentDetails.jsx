            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <button className="mt-4 bg-blue-600 text-gray-900 px-4 py-2 rounded-lg hover:bg-indigo-700">
                    Select Files
                  </button>
                </div>
                <button className="w-full bg-blue-600 text-gray-900 px-4 py-2 rounded-lg hover:bg-indigo-700">
                  Submit Assignment
                </button>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3">
              <a
                href="#"
                className="flex items-center space-x-3 text-blue-600 hover:text-indigo-700"
              >
