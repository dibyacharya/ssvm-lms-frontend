  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-blue-600 text-gray-900 px-4 py-2 rounded-lg hover:bg-indigo-700 flex items-center space-x-2">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-4 pt-4 border-t">
                  ...
                  <button className="text-blue-600 hover:text-indigo-700 font-medium">
                    View Submissions
                  </button>
                </div>
              </div>
